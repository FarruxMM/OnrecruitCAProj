...
namespace Online_recruitment_system.Areas.Admin.Controllers
{
    ...
    public class BranchesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,Location,PhoneNumber,Email,Id")] Branch branch)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Name,Location,PhoneNumber,Email,Id")] Branch branch)
        {
            if (id != branch.Id)
            {
                return NotFound();
