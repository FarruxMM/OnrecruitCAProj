        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Subject = table.Column<string>(type: "nvarchar(550)", maxLength: 550, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobSituations", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BirthDate = table.Column<DateTime>(type: "datetime2", maxLength: 150, nullable: false),
                    GenderId = table.Column<int>(type: "int", nullable: false),
                    Email = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    PhoneNumber = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    About = table.Column<string>(type: "nvarchar(750)", maxLength: 750, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JobSituationId = table.Column<int>(type: "int", nullable: false),
                    CreateDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Salary = table.Column<int>(type: "int", maxLength: 150, nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Jobs_JobSituations_JobSituationId",
                        column: x => x.JobSituationId,
                        principalTable: "JobSituations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Years = table.Column<DateTime>(type: "datetime2", maxLength: 150, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Resume_Uploading = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CandidateId = table.Column<int>(type: "int", nullable: false),
                    Resume_Bio = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Resume_Title = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Resume_Ext = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SkillToCandidates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SkillToCandidates_Candidates_CandidateId",
                        column: x => x.CandidateId,
                        principalTable: "Candidates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SkillToCandidates_Skills_SkillId",
                        column: x => x.SkillId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SocialLinks_Candidates_CandidateId",
                        column: x => x.CandidateId,
                        principalTable: "Candidates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JobFollowers_Candidates_CandidateId",
                        column: x => x.CandidateId,
                        principalTable: "Candidates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_JobFollowers_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobFollowers_CandidateId",
                table: "JobFollowers",
                column: "CandidateId");

            migrationBuilder.CreateIndex(
                name: "IX_JobFollowers_CategoryId",
                table: "JobFollowers",
                column: "CategoryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Jobs_JobSituationId",
                table: "Jobs",
                column: "JobSituationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SkillToCandidates_CandidateId",
                table: "SkillToCandidates",
                column: "CandidateId");

            migrationBuilder.CreateIndex(
                name: "IX_SkillToCandidates_SkillId",
                table: "SkillToCandidates",
                column: "SkillId");

            migrationBuilder.CreateIndex(
                name: "IX_SocialLinks_CandidateId",
                table: "SocialLinks",
                column: "CandidateId");
        }
